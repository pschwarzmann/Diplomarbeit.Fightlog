...
function safeSet(key, value) {
    try {
        ...
        logger.warn('Storage write blocked:', key, error);
    }
}
...
function safeGet(key) {
    try {
        ...
        logger.warn('Storage read blocked:', key, error);
        return null;
    }
}
...
function safeRemove(key) {
    try {
        ...
        logger.warn('Storage remove blocked:', key, error);
    }
}
...
export function readAuthSnapshot() {
    ...
    if (rawUser) {
        try {
            ...
            logger.warn('Stored user data invalid:', error);
        }
    }

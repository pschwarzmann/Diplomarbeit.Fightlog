...
class Security
{
    ...
    public static function setCorsHeaders(): void
    {
        ...
        // Security: In Production niemals * verwenden wenn Credentials gesendet werden
        if (empty($allowedOrigins) && !Env::isProduction()) {
            // Development: Erlaube nur localhost-Origins
    ...
    /**
     * Setzt Security-Header für besseren Schutz
     */
    public static function setSecurityHeaders(): void
    {
        ...
        // Clickjacking-Schutz: X-Frame-Options verhindert Einbetten in Frames
        header('X-Frame-Options: DENY');
        
        // XSS-Schutz: X-XSS-Protection (Legacy, aber hilfreich)
        header('X-XSS-Protection: 1; mode=block');
        
        // Referrer-Policy: Kontrolliert welche Referrer-Info gesendet wird

...
if (!$passwordVerified) {
    // Login-Versuch protokollieren
    Security::logLoginAttempt($identifier, false, $mysqli);
    AuditService::log($mysqli, 'login_failed', $user ? (int)$user['id'] : null, null, null, ['identifier' => $identifier]);
    // Allgemeine Fehlermeldung
    json_out(['success'=>false, 'error'=>'Login-Daten ungültig'], 401);
}
...
AuditService::log($mysqli, 'login_success', (int)$user['id'], null, null, ['identifier' => $identifier]);
